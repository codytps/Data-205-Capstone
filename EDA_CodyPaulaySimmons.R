...
# Unemployment Rate
dc_unemp_rate <- as.numeric(gsub("%", "", rate_row$District.of.Columbia..District.of.Columbia..Percent))
hi_unemp_rate <- as.numeric(gsub("%", "", rate_row$Hawaii.County..Hawaii..Percent))
